...
Thank you for your participation in the Access 102: Access Building Blocks 
Lab. This Lab Guide has highlighted several notable features of Access
Policy Manager (APM). It does not attempt to review all F5 APM features and 
configurations but serves as an introduction to allow the student to further
explore the BIG-IP platform and Access Policy Manager (APM), its functions & features.
